...
class ChaosTestSuite:
    ...
    async def test_llm_provider_failure_recovery(self) -> ChaosTestResult:
        ...
        try:
            ...
            fallback_provider.add_response(
                '{"intent": "order_status", "confidence": 0.8}'
            )
    ...
    async def test_retry_with_exponential_backoff(self) -> ChaosTestResult:
        ...
        try:
            ...
            if len(attempt_times) >= 2:
                ...
                assert 0.05 < delay1 < 0.3, (
                    f"Backoff delay should be ~0.1s, got {delay1:.3f}s"
                )
    ...
    async def test_cascading_failure_isolation(self) -> ChaosTestResult:
        ...
        try:
            ...
            service1_breaker = CircuitBreaker(
                "service1", CircuitBreakerConfig(failure_threshold=3)
            )
            service2_breaker = CircuitBreaker(
            ...
            assert service2_breaker.get_state().value == "closed", (
